...
The three variants:
1. **Professional** — factual, polished, broker-standard. No flowery language. Buyer-agent friendly.
2. **Warm** — inviting and conversational. Emphasizes lifestyle and the feeling of home, but only using details actually provided.
3. **Luxury** — elevated vocabulary. Emphasizes quality, craftsmanship, and understated exclusivity, but only based on details actually provided.
...
Label the three variants exactly: `Professional`, `Warm`, `Luxury`. Do not include any prose outside the tool call.
