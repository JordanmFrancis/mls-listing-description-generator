...
- src/prompts/listing-generator-v3.md — **active prompt**: 3 variants = Professional/Warm/Luxury
...
- tests/evals/fixtures.ts — 5 fixture listings with shouldMention soft signals
...
- Prompts versioned in filenames (v1, v2, v3); **never overwrite old versions** — bump and add new
...
- ✅ Eval suite: 5 fixtures, hard checks (3 variants, word count 100-250, no exclamations, no banned clichés), soft "shouldMention" signals. `npm run eval`. Currently 5/5 passing.
- ✅ Build clean (`npm run build`)
- ✅ GitHub: JordanmFrancis/mls-listing-description-generator, PR #1 open

## In progress
- Manual QA on dev server before merging PR #1
- Vercel deployment (after dad tests locally)

## Do not touch
- src/prompts/listing-generator-v1.md and v2.md — keep for history, do not delete or modify
